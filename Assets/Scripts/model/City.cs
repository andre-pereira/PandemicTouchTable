...
public class City : MonoBehaviour
{
    ...
    {
        new float[] { 0.61f, -0.0f },
        new float[] { 0.61f, -0.30f },
        new float[] { 0.61f, -0.60f }
    };

    public static readonly float[][] offsetCubesYellow = new float[][]
    {
        new float[] { 0.38f, -0.0f },
        new float[] { 0.38f, -0.30f },
        new float[] { 0.38f, -0.60f }
    };
    public static readonly float[][] offsetCubesBlue = new float[][]
    {
        new float[] { 0.15f, -0.0f },
        new float[] { 0.15f, -0.30f },
        new float[] { 0.15f, -0.60f }
    };
